...
export default class App extends Component {
    ...
    render() {
        return ( <
            ...
            BrowserRouter >
            <
            Header peerConnection = { this.state.peerConnection }
            ...
            Route exact path = "/" >
            <
            LandingPage peerConnection = { this.state.peerConnection }
            refreshPage = { this.refreshPage }
            /> <
            /Route> <
            Route path = "/generate-otp"
            render = {
                (props) => ( <
            ...
            /> <
            /Switch> <
            /BrowserRouter> { /* <div className="footer"></div> */ } <
            /div> <
